// Package captchagenerator provides a Go client for the Captcha Generator API.
//
// For more information, visit: https://apiverve.com/marketplace/captchagenerator?utm_source=go&utm_medium=readme
...
const (
	baseURL        = "https://api.apiverve.com/v1/captchagenerator"
	defaultTimeout = 30 * time.Second
)

// Client is the Captcha Generator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Captcha Generator API client.
...
// Execute makes a request to the Captcha Generator API.
