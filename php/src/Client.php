...
namespace APIVerve\Captchagenerator;
...
/**
 * Client for the Captcha Generator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/captchagenerator?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/captchagenerator';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\CaptchageneratorClient] {$message}\n";
        }
    }
}
